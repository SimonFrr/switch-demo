  ...
  <Col xs={12}>
    <Row>
      <Col xs={12} sm={8} smOffset={2} md={12} mdOffset={0}>
        ...
        <Alert>Complete your order of {planName} ({planPrice}) and you will receive your SIM card within two days. You can then port in a number for free when you activate your SIM.</Alert>
      </Col>
    </Row>
    <Row>
